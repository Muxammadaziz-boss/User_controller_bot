# ai_helper.py - v3.0.3 PRODUCTION READY
"""
...
class OpenRouterProvider(AsyncAIProvider):
    ...
    async def generate(self, prompt: str, model: str = None, max_tokens: int = 1000) -> Optional[str]:
        ...
        for try_model in models_to_try:
            ...
            if result:
                return result
            logger.warning(f"Model {try_model} failed, trying next...")
    ...
    async def generate_response(self, user_message: str) -> str:
        ...
        try:
            ...
            if result:
                ...
                return "❌ AI javob bermadi. API kalitni tekshiring yoki keyinroq urinib ko'ring."
