# config.py - v3.0.6 PRODUCTION CONFIGURATION
"""
🔒 XAVFSIZ: Barcha API kalitlar FAQAT .env fayldan yuklanadi
⚠️ Bu fayl GitHub'ga yuklash XAVFSIZ (.env yuklamang!)
...
# ==================== TELEGRAM API ====================
# ⚠️ MAJBURIY: .env faylda o'rnatilishi SHART!
